...
public class MainActivity3 extends AppCompatActivity {
    ...
    Button btnRegistrar;
    EditText txtvCorreoR, txtvConfCorreoR, txtvContraR, txtvConfContraR, txtvUsuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(Usuario) && !TextUtils.isEmpty(Correo) && !TextUtils.isEmpty(Contra) &&
                    ...
                    if (Correo.equals(confirmarCorreo) && Contra.equals(confirmarContra)) {
                        ...
                        // Almacena tanto el correo como el nombre de usuario
                        String correoCodificado = Correo.replace(".", "_");

                        // Almacena en la base de datos utilizando la referencia correcta
                        databaseReference.child(correoCodificado).setValue(usuarioMap);
                        databaseReference.child(Usuario).setValue(usuarioMap);

                        Toast.makeText(MainActivity3.this, "Usuario registrado exitosamente", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(MainActivity3.this, MainActivity2.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(MainActivity3.this, "Las contraseñas o correos no coinciden", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(MainActivity3.this, "Ingrese los datos requeridos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
